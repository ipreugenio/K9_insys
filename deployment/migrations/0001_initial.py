...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Daily_Refresher',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(auto_now_add=True, verbose_name='date')),
                ('rating', models.DecimalField(blank=True, decimal_places=2, max_digits=10, max_length=200, null=True, verbose_name='rating')),
                ...
                ('morning_feed_cups', models.IntegerField(blank=True, null=True, verbose_name='morning_feed_cups')),
                ('evening_feed_cups', models.IntegerField(blank=True, null=True, verbose_name='evening_feed_cups')),
                ('port_plant', models.IntegerField(default=0, verbose_name='port_plant')),
                ('port_find', models.IntegerField(default=0, verbose_name='port_find')),
                ('port_time', models.TimeField(blank=True, null=True, verbose_name='port_time')),
                ('building_plant', models.IntegerField(default=0, verbose_name='building_plant')),
                ('building_find', models.IntegerField(default=0, verbose_name='building_find')),
                ('building_time', models.TimeField(blank=True, null=True, verbose_name='building_time')),
                ('vehicle_plant', models.IntegerField(default=0, verbose_name='vehicle_plant')),
                ('vehicle_find', models.IntegerField(default=0, verbose_name='vehicle_find')),
                ('vehicle_time', models.TimeField(blank=True, null=True, verbose_name='vehicle_time')),
                ('baggage_plant', models.IntegerField(default=0, verbose_name='baggage_plant')),
                ('baggage_find', models.IntegerField(default=0, verbose_name='baggage_find')),
                ('baggage_time', models.TimeField(blank=True, null=True, verbose_name='baggage_time')),
                ('others_plant', models.IntegerField(default=0, verbose_name='others_plant')),
                ('others_find', models.IntegerField(default=0, verbose_name='others_find')),
                ('others_time', models.TimeField(blank=True, null=True, verbose_name='others_time')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sector_type', models.CharField(blank=True, choices=[('Disaster', 'Disaster'), ('Government Request', 'Government Request'), ('Annual Event', 'Annual Event'), ('Event', 'Event')], max_length=100, null=True, verbose_name='sector_type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('incident', models.CharField(blank=True, max_length=100, null=True, verbose_name='incident')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('place', models.CharField(default='Undefined', max_length=200, verbose_name='place')),
                ('sector_type', models.CharField(blank=True, choices=[('Mall', 'Mall'), ('Airport', 'Airport'), ('Government Building', 'Government Building')], max_length=100, null=True, verbose_name='sector_type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('EDD_demand', models.IntegerField(default=2, verbose_name='EDD_demand')),
                ('NDD_demand', models.IntegerField(default=2, verbose_name='NDD_demand')),
                ('SAR_demand', models.IntegerField(default=2, verbose_name='SAR_demand')),
                ('EDD_deployed', models.IntegerField(default=0, verbose_name='EDD_deployed')),
                ('NDD_deployed', models.IntegerField(default=0, verbose_name='NDD_deployed')),
                ('SAR_deployed', models.IntegerField(default=0, verbose_name='SAR_deployed')),
                ('total_dogs_demand', models.IntegerField(default=0, verbose_name='total_dogs_demand')),
                ...
                ('team_leader', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='profiles.User')),
            ],
        ),
        migrations.CreateModel(
