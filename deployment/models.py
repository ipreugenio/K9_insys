...
class Team_Assignment(models.Model):
    ...
    EDD_deployed = models.IntegerField('EDD_deployed', null=True, blank=True)
    NDD_deployed = models.IntegerField('NDD_deployed', null=True, blank=True)
    SAR_deployed = models.IntegerField('SAR_deployed', null=True, blank=True)
