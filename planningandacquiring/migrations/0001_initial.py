...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('breed', models.CharField(max_length=200, null=True, verbose_name='breed')),
                ...
                ('colors', models.CharField(max_length=200, null=True, verbose_name='colors')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year_retired', models.DateField(null=True, verbose_name='year_retired')),
                ('assignment', models.CharField(default='None', max_length=200, verbose_name='assignment')),
                ('status', models.CharField(choices=[('Material Dog', 'Material Dog'), ('Light Duty', 'Light Duty'), ('Adopted', 'Adopted'), ('Retired', 'Retired'), ('Dead', 'Dead'), ('Sick', 'Sick')], default='Material Dog', max_length=200, verbose_name='status')),
