# Generated by Django 2.1.2 on 2018-10-02 06:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile_number', models.IntegerField(max_length=200, verbose_name='mobile_number')),
                ...
                ('tin', models.IntegerField(max_length=200, verbose_name='tin')),
                ('philhealth', models.IntegerField(max_length=200, verbose_name='philhealth')),
            ],
        ),
        migrations.CreateModel(
            name='Users',
            fields=[
                ...
                ('height', models.IntegerField(max_length=200, verbose_name='height')),
                ('weight', models.IntegerField(max_length=200, verbose_name='weight')),
                ('headsize', models.IntegerField(max_length=200, verbose_name='headsize')),
                ('footsize', models.IntegerField(max_length=200, verbose_name='footsize')),
        ...
        migrations.AddField(
            ...
            name='UserID',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profiles.Users'),
        ),
    ]
